...
245 of the 249 are vendored from upstreams (the other 4 are first-party infrastructure);
...
`scripts/package_for_claude_ai.py` works, but the path covers the lean core: 32 of 249 skills have
