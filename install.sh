...
echo ""
echo "Those run against the sample company. To use your own, copy the template"
echo "and fill it in, then activate it:"
echo ""
echo "    cp -r core/clients/_template core/clients/mycompany"
echo "    bash scripts/activate_client.sh mycompany"
echo ""
