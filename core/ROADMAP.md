...
- Watch trigger overlap: reddit-marketing & linkedin-content (openclaudia) vs core skills — patch descriptions in overlay/patches/ if they misfire. **Done 2026-08-22**: an audit of all 133 descriptions found 14 topics with head-to-head claimants; description-only ROUTING patches now disambiguate reddit-marketing, linkedin-content, attribution, hubspot, community-marketing and marketing-council. Bodies stay byte-identical to upstream, so a re-vendor only needs the clause re-applied.

## Identified gap (from the sample-client test, 2026-07-25) — BUILT 2026-08-22
