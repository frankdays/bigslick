# Big Slick
**The open-source marketing distribution for Claude — 248 skills, every one of them redistributable.**
...
```bash
pip install pyyaml
python scripts/compose.py                      # -> skills/ (248) + .claude-plugin/plugin.json
...
all 248 are listed in **[INVENTORY.md](INVENTORY.md)**.
